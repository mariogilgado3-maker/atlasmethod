...
const EXERCISES_DB = [
  ...
  // ── PECHO — MÁQUINAS Y CABLES ─────────────────────────────────────────────
  {
    ...
    technicalDifficulty: 1,
    muscles: { primary: ['Pectoral mayor'], secondary: ['Tríceps', 'Deltoides ant.'] },
    variants: ['press-banca-mancuernas', 'press-banca-barra'],
    objectives: ['hipertrofia', 'recomp'],
    tags: ['pecho', 'máquina', 'principiante'],
    cues: ['Ajusta el asiento a la altura del esternón', 'No bloquees codos al final', 'Contrae el pecho en la extensión'],
  },
  {
    id: 'crossover-polea-alta',
    ...
    fatigueLoad: 2,
    technicalDifficulty: 2,
    muscles: { primary: ['Pectoral mayor (fibras medias-bajas)'], secondary: ['Deltoides ant.'] },
    variants: ['aperturas-mancuernas', 'peck-deck'],
    objectives: ['hipertrofia'],
    tags: ['pecho', 'polea', 'aislamiento', 'cables'],
    cues: ['Ligera inclinación hacia adelante', 'Arco amplio, codos ligeramente flexionados', 'Junta las manos por debajo del esternón'],
  },
  {
    id: 'peck-deck',
    name: 'Peck deck / Mariposa en máquina',
    pattern: 'empuje-horizontal',
    category: 'empuje',
    level: 'principiante',
    equipment: 'maquina',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Pectoral mayor'], secondary: ['Deltoides ant.'] },
    variants: ['crossover-polea-alta', 'aperturas-mancuernas'],
    objectives: ['hipertrofia'],
    tags: ['pecho', 'máquina', 'aislamiento'],
    cues: ['Codos a la altura de los hombros', 'No fuerces el rango en el estiramiento', 'Contracción máxima al cerrar'],
  },
  {
    ...
    technicalDifficulty: 3,
    muscles: { primary: ['Pectoral inferior'], secondary: ['Tríceps', 'Deltoides ant.'] },
    variants: ['fondos-paralelas', 'press-banca-barra'],
    objectives: ['hipertrofia', 'fuerza'],
    tags: ['pecho', 'pectoral-inferior', 'barra'],
    cues: ['Banco a 15-30° de declinación', 'Agarre algo más ancho que los hombros', 'Baja hasta el pecho inferior'],
  },
  {
    ...
    technicalDifficulty: 2,
    muscles: { primary: ['Pectoral superior', 'Deltoides ant.'], secondary: ['Tríceps'] },
    variants: ['press-inclinado-mancuernas', 'crossover-polea-alta'],
    objectives: ['hipertrofia'],
    tags: ['pecho', 'pectoral-superior', 'cables'],
    cues: ['Poleas en posición baja', 'Banco a 30-45°', 'Tensión constante durante todo el recorrido'],
  },

  // ── ESPALDA — MÁQUINAS Y CABLES ──────────────────────────────────────────
  {
    id: 'jalones-polea-agarre-neutro',
    name: 'Jalones en polea agarre neutro',
    pattern: 'traccion-vertical',
    category: 'traccion',
    level: 'principiante',
    equipment: 'polea',
    ...
    fatigueLoad: 2,
    technicalDifficulty: 2,
    muscles: { primary: ['Dorsal ancho', 'Bíceps'], secondary: ['Romboides', 'Trapecio medio'] },
    variants: ['jalones-polea-prono', 'dominadas'],
    objectives: ['hipertrofia', 'recomp'],
    tags: ['espalda', 'polea', 'agarre-neutro'],
    cues: ['Tira hacia el esternón', 'Lleva codos hacia las caderas', 'No te inclines demasiado'],
  },
  {
    id: 'remo-polea-baja-agarre-neutro',
    name: 'Remo en polea baja agarre neutro',
    pattern: 'traccion-horizontal',
    category: 'traccion',
    level: 'principiante',
    equipment: 'polea',
    ...
    variants: ['remo-barra', 'remo-mancuerna'],
    objectives: ['hipertrofia', 'recomp'],
    tags: ['espalda', 'polea', 'remo'],
    cues: ['Espalda recta, no uses el torso', 'Tira hasta el abdomen bajo', 'Comprime escápulas al final'],
  },
  {
    id: 'remo-maquina',
    ...
    technicalDifficulty: 1,
    muscles: { primary: ['Dorsal ancho', 'Romboides'], secondary: ['Bíceps', 'Deltoides post.'] },
    variants: ['remo-polea-baja-agarre-neutro', 'remo-barra'],
    objectives: ['hipertrofia', 'recomp'],
    tags: ['espalda', 'máquina', 'remo'],
    cues: ['Ajusta el pecho pad a la altura del esternón', 'Tira con los codos, no las manos', 'Control excéntrico completo'],
  },
  {
    id: 'pullover-polea',
    ...
    fatigueLoad: 2,
    technicalDifficulty: 2,
    muscles: { primary: ['Dorsal ancho'], secondary: ['Serrato', 'Pectoral mayor'] },
    variants: ['pullover-mancuerna', 'jalones-polea-prono'],
    objectives: ['hipertrofia'],
    tags: ['espalda', 'dorsal', 'aislamiento', 'cables'],
    cues: ['Brazos extendidos durante todo el movimiento', 'Tira con el dorsal, no los brazos', 'Estiramiento máximo en la posición inicial'],
  },
  {
    id: 'facepull',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 2,
    muscles: { primary: ['Deltoides post.', 'Manguito rotador'], secondary: ['Trapecio medio', 'Romboides'] },
    variants: ['pajaro-mancuernas', 'remo-maquina'],
    objectives: ['hipertrofia', 'recomp', 'salud'],
    tags: ['hombro-posterior', 'manguito-rotador', 'salud', 'cables'],
    cues: ['Polea a la altura de los ojos', 'Tira hacia la cara, codos por encima de las manos', 'Rotación externa máxima al final'],
  },
  ...
  // ── HOMBROS ───────────────────────────────────────────────────────────────
  {
    ...
    fatigueLoad: 3,
    technicalDifficulty: 3,
    muscles: { primary: ['Deltoides (los 3 haces)'], secondary: ['Tríceps', 'Trapecio'] },
    variants: ['press-militar-mancuernas', 'press-militar-barra'],
    objectives: ['hipertrofia'],
    tags: ['hombro', 'mancuernas', 'desarrollo-completo'],
    cues: ['Empieza con palmas hacia ti', 'Rota a lo largo del recorrido', 'Control total en el descenso'],
  },
  {
    ...
    fatigueLoad: 1,
    technicalDifficulty: 2,
    muscles: { primary: ['Deltoides lateral'], secondary: [] },
    variants: ['elevaciones-laterales', 'press-arnold'],
    objectives: ['hipertrofia'],
    tags: ['hombro', 'deltoides-lateral', 'cables', 'tensión-constante'],
    cues: ['Polea baja, cable por delante del cuerpo', 'Eleva con el codo, no la muñeca', 'Máximo 90° — paralelo al suelo'],
  },
  {
    id: 'upright-row',
    ...
    fatigueLoad: 2,
    technicalDifficulty: 3,
    muscles: { primary: ['Deltoides lateral', 'Trapecio'], secondary: ['Bíceps', 'Deltoides ant.'] },
    variants: ['elevaciones-laterales', 'press-militar-barra'],
    objectives: ['hipertrofia'],
    tags: ['hombro', 'trapecio', 'barra'],
    cues: ['Agarre ancho (más que hombros)', 'Codos por encima de las muñecas', 'No subas más allá de la barbilla'],
  },
  {
    id: 'elevaciones-frontales-alternas',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Deltoides ant.'], secondary: ['Trapecio', 'Pectoral mayor (clavicular)'] },
    variants: ['press-arnold', 'elevaciones-laterales'],
    objectives: ['hipertrofia'],
    tags: ['hombro', 'deltoides-anterior', 'mancuernas'],
    cues: ['Alterna los brazos, no balancees', 'Para a la altura de los hombros', 'Pulgar arriba para mayor activación'],
  },
  ...
  // ── TRAPECIOS ────────────────────────────────────────────────────────────
  {
    ...
    technicalDifficulty: 1,
    muscles: { primary: ['Trapecio superior'], secondary: ['Elevador de la escápula'] },
    variants: ['encogimientos-mancuernas', 'encogimientos-polea'],
    objectives: ['hipertrofia', 'fuerza'],
    tags: ['trapecio', 'cuello', 'barra'],
    cues: ['Encoge hacia las orejas', 'Sin rotación de hombros', 'Pausa 1 segundo arriba'],
  },
  {
    ...
    technicalDifficulty: 1,
    muscles: { primary: ['Trapecio superior'], secondary: ['Elevador de la escápula'] },
    variants: ['encogimientos-barra', 'remo-barra'],
    objectives: ['hipertrofia'],
    tags: ['trapecio', 'mancuernas'],
    cues: ['Mayor rango de movimiento que con barra', 'Lleva los hombros hacia las orejas', 'Control en el descenso'],
  },
  ...
  // ── BÍCEPS ───────────────────────────────────────────────────────────────
  {
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Bíceps braquial'], secondary: ['Braquial', 'Supinador'] },
    variants: ['curl-barra', 'curl-mancuernas'],
    objectives: ['hipertrofia'],
    tags: ['bíceps', 'polea', 'tensión-constante'],
    cues: ['Tensión constante en todo el recorrido', 'Codos pegados al cuerpo', 'Supina en la parte superior'],
  },
  {
    id: 'curl-concentrado',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Bíceps braquial (pico)'], secondary: ['Braquial'] },
    variants: ['curl-mancuernas', 'curl-predicador'],
    objectives: ['hipertrofia'],
    tags: ['bíceps', 'mancuernas', 'aislamiento'],
    cues: ['Codo apoyado en la cara interna del muslo', 'Supina al subir', 'Control total en el descenso'],
  },
  {
    id: 'curl-martillo-cable',
    name: 'Curl martillo en cable',
    pattern: 'traccion-vertical',
    category: 'traccion',
    level: 'principiante',
    equipment: 'polea',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Braquiorradial', 'Braquial'], secondary: ['Bíceps'] },
    variants: ['curl-martillo', 'curl-polea-baja'],
    objectives: ['hipertrofia'],
    tags: ['bíceps', 'braquial', 'cables'],
    cues: ['Agarre neutro (pulgar arriba)', 'Sin balanceo', 'Codos fijos a los costados'],
  },
  {
    id: 'curl-spider',
    name: 'Curl Spider / Predicador con mancuerna',
    pattern: 'traccion-vertical',
    category: 'traccion',
    level: 'intermedio',
    equipment: 'mancuernas',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 2,
    muscles: { primary: ['Bíceps braquial (cabeza corta)'], secondary: ['Braquial'] },
    variants: ['curl-predicador', 'curl-concentrado'],
    objectives: ['hipertrofia'],
    tags: ['bíceps', 'mancuernas', 'banco-inclinado'],
    cues: ['Banco a 45°, pecho apoyado', 'Codos bloqueados en el pad', 'Estiramiento máximo abajo'],
  },

  // ── TRÍCEPS ───────────────────────────────────────────────────────────────
  {
    id: 'press-frances-barra-ez',
    ...
    technicalDifficulty: 3,
    muscles: { primary: ['Tríceps braquial (cabeza larga)'], secondary: [] },
    variants: ['overhead-tricep-extension', 'tricep-press-polea'],
    objectives: ['hipertrofia', 'fuerza'],
    tags: ['tríceps', 'barra-ez', 'cabeza-larga'],
    cues: ['Barra baja hacia la frente controlando', 'Codos apuntando al techo', 'Extiende sin bloquear completamente'],
  },
  {
    id: 'tricep-press-polea',
    name: 'Press en polea con barra recta (tríceps)',
    pattern: 'empuje-vertical',
    category: 'empuje',
    level: 'principiante',
    equipment: 'polea',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Tríceps braquial (cabeza lateral y media)'], secondary: [] },
    variants: ['tricep-polea-cuerda', 'fondos-banco'],
    objectives: ['hipertrofia'],
    tags: ['tríceps', 'polea', 'cables'],
    cues: ['Codos pegados a los costados fijos', 'Extiende completamente', 'Control al subir'],
  },
  {
    id: 'tricep-polea-cuerda',
    name: 'Jalón tríceps en polea con cuerda',
    pattern: 'empuje-vertical',
    category: 'empuje',
    level: 'principiante',
    equipment: 'polea',
    ...
    technicalDifficulty: 1,
    muscles: { primary: ['Tríceps braquial'], secondary: [] },
    variants: ['tricep-press-polea', 'fondos-banco'],
    objectives: ['hipertrofia'],
    tags: ['tríceps', 'polea', 'cuerda'],
    cues: ['Separa la cuerda al final para activar la cabeza lateral', 'Codos fijos', 'Extensión completa'],
  },
  {
    id: 'kickback-mancuerna',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 2,
    muscles: { primary: ['Tríceps braquial (cabeza lateral)'], secondary: [] },
    variants: ['tricep-polea-cuerda', 'fondos-banco'],
    objectives: ['hipertrofia'],
    tags: ['tríceps', 'mancuernas', 'aislamiento'],
    cues: ['Torso paralelo al suelo', 'Brazo pegado al cuerpo', 'Extiende el codo completamente'],
  },
  ...
  // ── PIERNAS — CUÁDRICEPS ──────────────────────────────────────────────────
  {
    ...
    fatigueLoad: 3,
    technicalDifficulty: 1,
    muscles: { primary: ['Cuádriceps', 'Glúteo mayor'], secondary: ['Isquios', 'Aductores'] },
    variants: ['sentadilla-barra', 'hack-squat'],
    objectives: ['hipertrofia', 'fuerza', 'recomp'],
    tags: ['pierna', 'cuádriceps', 'máquina', 'volumen'],
    cues: ['Pies a anchura de caderas o más', 'Rodillas siguen la línea de los dedos', 'No bloquees rodillas al extender'],
  },
  {
    id: 'hack-squat',
    name: 'Hack squat en máquina',
    ...
    fatigueLoad: 3,
    technicalDifficulty: 2,
    muscles: { primary: ['Cuádriceps', 'Glúteo mayor'], secondary: ['Isquios'] },
    variants: ['leg-press', 'sentadilla-barra'],
    objectives: ['hipertrofia', 'fuerza'],
    tags: ['pierna', 'cuádriceps', 'máquina'],
    cues: ['Pies bajos para más cuádriceps', 'Profundidad completa', 'Control en la fase negativa'],
  },
  {
    id: 'extension-cuadriceps',
    ...
    variants: ['leg-press', 'sentadilla-barra'],
    objectives: ['hipertrofia', 'recomp'],
    tags: ['pierna', 'cuádriceps', 'aislamiento', 'máquina'],
    cues: ['Ajusta el pad a los tobillos', 'Extensión completa, pausa arriba', 'Baja lento (3s excéntrico)'],
  },
  {
    id: 'zancada-con-mancuernas',
    ...
    fatigueLoad: 3,
    technicalDifficulty: 2,
    muscles: { primary: ['Cuádriceps', 'Glúteo mayor'], secondary: ['Isquios', 'Core'] },
    variants: ['zancada-barra', 'prensa-unilateral'],
    objectives: ['hipertrofia', 'recomp', 'perdida_grasa'],
    tags: ['pierna', 'cuádriceps', 'glúteo', 'zancada'],
    cues: ['Paso largo, rodilla no toca el suelo', 'Torso erguido', 'Rodilla trasera a 90°'],
  },
  {
    ...
    fatigueLoad: 2,
    technicalDifficulty: 1,
    muscles: { primary: ['Cuádriceps', 'Glúteo mayor'], secondary: ['Core', 'Aductores'] },
    variants: ['sentadilla-barra', 'leg-press'],
    objectives: ['hipertrofia', 'recomp', 'perdida_grasa'],
    tags: ['pierna', 'cuádriceps', 'kettlebell', 'principiante'],
    cues: ['Kettlebell apoyado en el pecho', 'Codos hacia dentro al bajar', 'Profundidad completa'],
  },
  {
    id: 'sentadilla-bulgara',
    ...
    fatigueLoad: 3,
    technicalDifficulty: 3,
    muscles: { primary: ['Cuádriceps', 'Glúteo mayor'], secondary: ['Isquios', 'Core', 'Aductores'] },
    variants: ['zancada-con-mancuernas', 'leg-press'],
    objectives: ['hipertrofia', 'fuerza', 'recomp'],
    tags: ['pierna', 'unilateral', 'cuádriceps', 'glúteo'],
    cues: ['Pie trasero elevado a la altura de la rodilla', 'Rodilla delantera sigue el dedo gordo', 'Torso ligeramente inclinado'],
  },

  // ── PIERNAS — ISQUIOS / FEMORAL ──────────────────────────────────────────
  {
    id: 'curl-femoral-tumbado',
    ...
    fatigueLoad: 2,
    technicalDifficulty: 1,
    muscles: { primary: ['Isquiotibiales'], secondary: ['Gastrocnemios'] },
    variants: ['curl-femoral-sentado', 'peso-muerto-rumano'],
    objectives: ['hipertrofia', 'recomp'],
    tags: ['pierna', 'isquios', 'máquina'],
    cues: ['Ajusta el pad encima del talón', 'Pelvis en neutro, sin arqueamiento', 'Control total en el negativo'],
  },
  {
    ...
    fatigueLoad: 2,
    technicalDifficulty: 1,
    muscles: { primary: ['Isquiotibiales (porción superior)'], secondary: ['Gastrocnemios'] },
    variants: ['curl-femoral-tumbado', 'peso-muerto-rumano'],
    objectives: ['hipertrofia'],
    tags: ['pierna', 'isquios', 'máquina', 'porción-superior'],
    cues: ['Mayor activación proximal que tumbado', 'Cadera flexionada aumenta elongación', 'Extiende completamente al bajar'],
  },
  {
    id: 'nordic-curl',
    ...
    fatigueLoad: 3,
    technicalDifficulty: 4,
    muscles: { primary: ['Isquiotibiales (cabeza corta y larga)'], secondary: ['Gastrocnemios'] },
    variants: ['curl-femoral-tumbado', 'peso-muerto-rumano'],
    objectives: ['fuerza', 'rendimiento', 'prevención-lesiones'],
    tags: ['pierna', 'isquios', 'peso-corporal', 'prevención'],
    cues: ['Pies fijos bajo una barra', 'Baja lento controlando la caída', 'Apóyate en el suelo y empuja de vuelta'],
  },
  {
    id: 'peso-muerto-sumo',
    ...
    fatigueLoad: 4,
    technicalDifficulty: 3,
    muscles: { primary: ['Aductores', 'Glúteo mayor', 'Cuádriceps'], secondary: ['Isquios', 'Lumbar', 'Trapecios'] },
    variants: ['peso-muerto', 'peso-muerto-rumano'],
    objectives: ['fuerza', 'hipertrofia'],
    tags: ['pierna', 'glúteo', 'aductores', 'barra', 'compuesto'],
    cues: ['Pies muy abiertos, puntas hacia fuera', 'Barra sobre el mediopié', 'Caderas más bajas que en el peso muerto convencional'],
  },
  ...
  // ── GLÚTEOS ───────────────────────────────────────────────────────────────
  {
    ...
    variants: ['hip-thrust', 'puente-gluteo'],
    objectives: ['hipertrofia', 'recomp'],
    tags: ['glúteo', 'mancuernas', 'cadera'],
    cues: ['Hombros en el banco, mancuerna sobre las caderas', 'Empuja con los talones', 'Contracción máxima arriba 1 seg'],
  },
  {
    id: 'patada-trasera-cable',
    name: 'Patada trasera en cable (glúteo)',
    pattern: 'cadera',
    category: 'gluten',
    level: 'principiante',
    equipment: 'polea',
    ...
    variants: ['hip-thrust', 'puente-gluteo'],
    objectives: ['hipertrofia', 'recomp'],
    tags: ['glúteo', 'cables', 'aislamiento'],
    cues: ['Polea baja, tobillera puesta', 'Mantén el torso estable', 'Extiende completamente sin arquear lumbar'],
  },
  {
    id: 'abductor-maquina',
    name: 'Abducción en máquina (abductor)',
    pattern: 'cadera',
    category: 'gluten',
    level: 'principiante',
    equipment: 'maquina',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Glúteo medio', 'Glúteo menor'], secondary: ['Tensor fascia lata'] },
    variants: ['abduccion-cable', 'hip-thrust'],
    objectives: ['hipertrofia'],
    tags: ['glúteo', 'glúteo-medio', 'máquina'],
    cues: ['Posición recta, no te inclines', 'Abre las piernas lento y controla el cierre', 'Contrae el glúteo medio al abrir'],
  },
  {
    id: 'step-up-mancuernas',
    ...
    fatigueLoad: 2,
    technicalDifficulty: 2,
    muscles: { primary: ['Glúteo mayor', 'Cuádriceps'], secondary: ['Isquios', 'Core'] },
    variants: ['zancada-con-mancuernas', 'sentadilla-bulgara'],
    objectives: ['hipertrofia', 'recomp', 'perdida_grasa'],
    tags: ['glúteo', 'pierna', 'mancuernas', 'funcional'],
    cues: ['Sube con el talón del pie elevado, no el de la pierna de apoyo', 'Rodilla alineada', 'Desciende con control'],
  },
  {
    id: 'good-morning',
    ...
    fatigueLoad: 3,
    technicalDifficulty: 4,
    muscles: { primary: ['Isquios', 'Glúteo mayor', 'Lumbar'], secondary: ['Core', 'Trapecios'] },
    variants: ['peso-muerto-rumano', 'peso-muerto'],
    objectives: ['fuerza', 'hipertrofia'],
    tags: ['glúteo', 'isquios', 'lumbar', 'bisagra', 'barra'],
    cues: ['Barra alta en el trapecio', 'Empuja caderas hacia atrás', 'Espalda recta, ligera flexión en rodillas'],
  },
  ...
  // ── PANTORRILLAS ─────────────────────────────────────────────────────────
  {
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Sóleo'], secondary: ['Gastrocnemio'] },
    variants: ['elevacion-talones-de-pie', 'elevacion-talones-burro'],
    objectives: ['hipertrofia'],
    tags: ['pantorrilla', 'sóleo', 'máquina'],
    cues: ['Rodillas a 90°, más aislamiento del sóleo', 'Rango completo: estiramiento máximo abajo', 'Pausa 1s arriba con contracción'],
  },
  {
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Gastrocnemio'], secondary: ['Sóleo'] },
    variants: ['elevacion-talones-sentado', 'elevacion-talones-burro'],
    objectives: ['hipertrofia', 'recomp'],
    tags: ['pantorrilla', 'gastrocnemio', 'peso-corporal'],
    cues: ['Pierna extendida para mayor activación del gemelo', 'Rango completo', 'Progresa a unilateral'],
  },
  {
    id: 'elevacion-talones-burro',
    name: 'Elevación de talones burro / burrro calf raise',
    pattern: 'cadera',
    category: 'pierna',
    level: 'intermedio',
    equipment: 'maquina',
    ...
    fatigueLoad: 2,
    technicalDifficulty: 2,
    muscles: { primary: ['Gastrocnemio', 'Sóleo'], secondary: [] },
    variants: ['elevacion-talones-de-pie', 'elevacion-talones-sentado'],
    objectives: ['hipertrofia'],
    tags: ['pantorrilla', 'máquina', 'rango-completo'],
    cues: ['Cadera flexionada para mayor activación', 'Rango máximo de movimiento', 'Alta repetición funciona bien'],
  },
  {
    ...
    variants: ['elevacion-talones-de-pie', 'elevacion-talones-sentado'],
    objectives: ['hipertrofia', 'fuerza'],
    tags: ['pantorrilla', 'unilateral', 'peso-corporal'],
    cues: ['Mano en soporte para equilibrio', 'Rango completo — máximo abajo', 'Sin peso extra para empezar'],
  },

  // ── ANTEBRAZO / FOREARM ──────────────────────────────────────────────────
  {
    id: 'curl-muneca-barra',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Flexores del antebrazo'], secondary: [] },
    variants: ['curl-muneca-mancuernas', 'agarre-pinza'],
    objectives: ['hipertrofia', 'rendimiento'],
    tags: ['antebrazo', 'flexores', 'muñeca'],
    cues: ['Antebrazos apoyados en el banco', 'Solo mueve la muñeca', 'Control total en ambas fases'],
  },
  {
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Extensores del antebrazo'], secondary: ['Braquiorradial'] },
    variants: ['curl-muneca-barra', 'curl-martillo'],
    objectives: ['hipertrofia', 'salud'],
    tags: ['antebrazo', 'extensores', 'equilibrio'],
    cues: ['Agarre prono (palmas abajo)', 'Muñeca sube y baja solo', 'Imprescindible para equilibrio del codo'],
  },
  {
    id: 'agarre-pinza',
    name: 'Agarre de pinza con disco',
    pattern: 'traccion-vertical',
    category: 'traccion',
    level: 'principiante',
    equipment: 'barra',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 1,
    muscles: { primary: ['Flexores de los dedos', 'Musculatura intrínseca de la mano'], secondary: [] },
    variants: ['curl-muneca-barra', 'farmer-carry'],
    objectives: ['fuerza', 'rendimiento'],
    tags: ['antebrazo', 'agarre', 'dedos'],
    cues: ['Coge el disco por el borde con dedos', 'Mantén el tiempo máximo posible', 'Progresa aumentando tiempo o peso'],
  },
  {
    id: 'farmer-carry',
    name: 'Farmer carry (marcha con peso)',
    pattern: 'core-antiextension',
    category: 'core',
    level: 'principiante',
    equipment: 'mancuernas',
    ...
    fatigueLoad: 2,
    technicalDifficulty: 1,
    muscles: { primary: ['Flexores del antebrazo', 'Core', 'Trapecio'], secondary: ['Deltoides', 'Glúteos', 'Pantorrillas'] },
    variants: ['agarre-pinza', 'plancha-frontal'],
    objectives: ['fuerza', 'rendimiento', 'recomp'],
    tags: ['antebrazo', 'agarre', 'funcional', 'core'],
    cues: ['Hombros retraídos y deprimidos', 'Paso corto y controlado', 'Nunca pierdas el core'],
  },
  ...
  // ── CORE — ADICIONALES ────────────────────────────────────────────────────
  {
    ...
    fatigueLoad: 1,
    technicalDifficulty: 2,
    muscles: { primary: ['Oblicuos', 'Transverso abdominal'], secondary: ['Core profundo'] },
    variants: ['russian-twist', 'plancha-lateral'],
    objectives: ['fuerza', 'rendimiento', 'salud'],
    tags: ['core', 'antirrotación', 'cables', 'funcional'],
    cues: ['Polea a la altura del pecho', 'Empuja y mantén sin rotar', 'Cuanto más lejos estés, más difícil'],
  },
  {
    id: 'dragon-flag',
    name: 'Dragon flag',
    ...
    fatigueLoad: 3,
    technicalDifficulty: 4,
    muscles: { primary: ['Recto abdominal', 'Core completo'], secondary: ['Flexores de cadera', 'Cuádriceps'] },
    variants: ['hollow-body-hold', 'elevacion-piernas-colgado'],
    objectives: ['fuerza', 'rendimiento'],
    tags: ['core', 'avanzado', 'peso-corporal', 'gimnasia'],
    cues: ['Sujeta el banco detrás de la cabeza', 'Cuerpo rígido como una tabla', 'Baja controlando completamente'],
  },
  {
    id: 'crunch-cable',
    ...
    technicalDifficulty: 2,
    muscles: { primary: ['Recto abdominal'], secondary: ['Oblicuos'] },
    variants: ['crunch-abdominal', 'elevacion-piernas-colgado'],
    objectives: ['hipertrofia'],
    tags: ['core', 'abdomen', 'cables'],
    cues: ['Polea alta, cuerda en la nuca', 'Contrae el abdomen hacia el suelo', 'No uses el cuello ni los flexores'],
  },
  {
    id: 'rotacion-rusa-cable',
    name: 'Rotación rusa en cable',
    pattern: 'core-antirrotacion',
    category: 'core',
    level: 'intermedio',
    equipment: 'polea',
    ...
    fatigueLoad: 1,
    technicalDifficulty: 2,
    muscles: { primary: ['Oblicuos'], secondary: ['Transverso abdominal', 'Recto abdominal'] },
    variants: ['russian-twist', 'pallof-press'],
    objectives: ['hipertrofia', 'rendimiento'],
    tags: ['core', 'oblicuos', 'cables', 'rotación'],
    cues: ['Polea a la altura de los hombros', 'Brazos extendidos, gira desde el torso', 'Caderas quietas'],
  },
  ...
  // ── PESO CORPORAL COMPUESTO ───────────────────────────────────────────────
  {
    ...
    fatigueLoad: 3,
    technicalDifficulty: 2,
    muscles: { primary: ['Cuerpo completo'], secondary: [] },
    variants: ['mountain-climber', 'plancha-frontal'],
    objectives: ['perdida_grasa', 'recomp'],
    tags: ['cardio', 'cuerpo-completo', 'peso-corporal'],
    cues: ['Aterrizaje suave al saltar', 'Plancha firme al bajar', 'Ritmo constante'],
  },
  {
    id: 'muscle-up',
    ...
    fatigueLoad: 4,
    technicalDifficulty: 4,
    muscles: { primary: ['Dorsal ancho', 'Bíceps', 'Tríceps', 'Core'], secondary: ['Pectoral', 'Deltoides'] },
    variants: ['dominadas', 'fondos-paralelas'],
    objectives: ['fuerza', 'rendimiento'],
    tags: ['peso-corporal', 'calistenia', 'avanzado'],
    cues: ['Requiere dominar dominadas y fondos', 'Transición explosiva', 'Falso agarre en la versión en argollas'],
  },
  {
    id: 'pike-push-up',
    name: 'Pike push-up',
    ...
    fatigueLoad: 2,
    technicalDifficulty: 2,
    muscles: { primary: ['Deltoides', 'Tríceps'], secondary: ['Trapecio', 'Core'] },
    variants: ['press-militar-barra', 'flexion-diamante'],
    objectives: ['fuerza', 'recomp'],
    tags: ['peso-corporal', 'hombros', 'calistenia'],
    cues: ['Caderas altas formando una V', 'Cabeza entre los brazos al bajar', 'Progresión hacia el handstand push-up'],
  },
  {
    id: 'flexion-diamante',
    ...
    fatigueLoad: 2,
    technicalDifficulty: 2,
    muscles: { primary: ['Tríceps'], secondary: ['Pectoral mayor (interno)', 'Deltoides ant.'] },
    variants: ['fondos-banco', 'tricep-polea-cuerda'],
    objectives: ['hipertrofia', 'fuerza'],
    tags: ['tríceps', 'peso-corporal', 'calistenia'],
    cues: ['Manos juntas formando un triángulo', 'Codos pegados al cuerpo al bajar', 'Cuerpo rígido en todo momento'],
  },
  {
    id: 'australian-pull-up',
    name: 'Dominada australiana (inverted row)',
    pattern: 'traccion-horizontal',
    category: 'traccion',
    level: 'principiante',
    equipment: 'peso-corporal',
    ...
    technicalDifficulty: 1,
    muscles: { primary: ['Dorsal ancho', 'Romboides'], secondary: ['Bíceps', 'Trapecio medio'] },
    variants: ['remo-barra', 'dominadas'],
    objectives: ['fuerza', 'recomp'],
    tags: ['espalda', 'peso-corporal', 'progresión'],
    cues: ['Cuerpo rígido inclinado hacia atrás', 'Tira el pecho hacia la barra', 'Cuanto más horizontal, más difícil'],
  },
];
