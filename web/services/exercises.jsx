...
const EXERCISES_DB = [
  ...
  },
  {
    ...
    fatigueLoad: 2,
    technicalDifficulty: 2,
    muscles: { primary: ['Aductor mayor', 'Cuádriceps'], secondary: ['Glúteos', 'Isquios'] },
    variants: ['maquina-aductores', 'sentadilla-trasera'],
    objectives: ['hipertrofia', 'recomp', 'rendimiento'],
    tags: ['aductores', 'sentadilla', 'funcional'],
    cues: ['Pies más anchos que hombros, puntas afuera', 'Rodillas en línea con los pies', 'Mancuerna colgando entre las piernas'],
  },
  {
    id: 'copenhagen-plank',
